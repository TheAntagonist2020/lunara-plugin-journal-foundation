...
1. Replace the existing LUNARA Journal Foundation with version 1.2.8.
...
5. Keep the current GPT instructions; the 1.2.8 automation routes are separate from the Journal Editor Action schema.
